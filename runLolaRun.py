...
class Lola:
    def __init__(self, win, center1, distance1,speed1,jumpHeight1,LolaRadius,LolaImage):
        self.center=center1
        ...
        self.Lola=Image(center1,LolaImage)
        self.Lola.draw(win)
...
def main():
    ...
    lola=Lola(win, center1, distance1,speed1,jumpHeight1,LolaRadius,gif1)   
##    while (n<450):
##            gif[0].draw(win)
##            time.sleep(1)
##            gif[0].undraw()
